/**
 * Fraud Detection Rule: AddressMismatchDetector
 * Evaluates real-time transaction anomalies, behavioral heuristics, and risk indices.
 */

class AddressMismatchDetectorRule {
  constructor() {
    this.ruleId = 'address-mismatch-detector';
...
module.exports = new AddressMismatchDetectorRule();
