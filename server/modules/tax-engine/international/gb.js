/**
 * International Tax Jurisdiction Engine: UnitedKingdom (GB)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_GB {
  constructor() {
    this.jurisdictionCode = 'GB';
    this.countryName = 'UnitedKingdom';
    this.statutoryName = 'UK Value Added Tax';
    this.standardVatRate = 0.2;
...
module.exports = new IntlTaxEngine_GB();
