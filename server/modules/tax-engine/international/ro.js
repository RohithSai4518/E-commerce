/**
 * International Tax Jurisdiction Engine: Romania (RO)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_RO {
  constructor() {
    this.jurisdictionCode = 'RO';
    this.countryName = 'Romania';
    this.statutoryName = 'Taxa pe valoarea adaugata';
    this.standardVatRate = 0.19;
    this.reducedVatRate = 0.09;
...
module.exports = new IntlTaxEngine_RO();
