/**
 * International Tax Jurisdiction Engine: Switzerland (CH)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_CH {
  constructor() {
    this.jurisdictionCode = 'CH';
    this.countryName = 'Switzerland';
    this.statutoryName = 'Swiss VAT / MWST';
    this.standardVatRate = 0.081;
    this.reducedVatRate = 0.026;
...
module.exports = new IntlTaxEngine_CH();
