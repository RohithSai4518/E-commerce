/**
 * International Tax Jurisdiction Engine: Portugal (PT)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_PT {
  constructor() {
    this.jurisdictionCode = 'PT';
    this.countryName = 'Portugal';
    this.statutoryName = 'Imposto sobre o Valor Acrescentado';
...
module.exports = new IntlTaxEngine_PT();
