/**
 * International Tax Jurisdiction Engine: Czechia (CZ)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_CZ {
  constructor() {
    this.jurisdictionCode = 'CZ';
    this.countryName = 'Czechia';
    this.statutoryName = 'Dan z pridane hodnoty';
    this.standardVatRate = 0.21;
    this.reducedVatRate = 0.12;
...
module.exports = new IntlTaxEngine_CZ();
