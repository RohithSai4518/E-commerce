/**
 * International Tax Jurisdiction Engine: Hungary (HU)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_HU {
  constructor() {
    this.jurisdictionCode = 'HU';
    this.countryName = 'Hungary';
    this.statutoryName = 'Általános forgalmi adó';
    this.standardVatRate = 0.27;
    this.reducedVatRate = 0.18;
...
module.exports = new IntlTaxEngine_HU();
