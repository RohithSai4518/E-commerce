/**
 * International Tax Jurisdiction Engine: Canada_Quebec (CA_QC)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_CA_QC {
  constructor() {
    this.jurisdictionCode = 'CA_QC';
    this.countryName = 'Canada_Quebec';
    this.statutoryName = 'Quebec Sales Tax (QST)';
    this.standardVatRate = 0.14975;
...
module.exports = new IntlTaxEngine_CA_QC();
