/**
 * International Tax Jurisdiction Engine: France (FR)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_FR {
  constructor() {
    this.jurisdictionCode = 'FR';
    this.countryName = 'France';
    this.statutoryName = 'Taxe sur la valeur ajoutée';
    this.standardVatRate = 0.2;
    this.reducedVatRate = 0.055;
...
module.exports = new IntlTaxEngine_FR();
