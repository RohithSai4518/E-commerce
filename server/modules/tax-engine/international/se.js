/**
 * International Tax Jurisdiction Engine: Sweden (SE)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_SE {
  constructor() {
    this.jurisdictionCode = 'SE';
    this.countryName = 'Sweden';
    this.statutoryName = 'Mervärdesskatt';
    this.standardVatRate = 0.25;
...
module.exports = new IntlTaxEngine_SE();
