/**
 * International Tax Jurisdiction Engine: NewZealand (NZ)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_NZ {
  constructor() {
    this.jurisdictionCode = 'NZ';
    this.countryName = 'NewZealand';
    this.statutoryName = 'New Zealand GST';
    this.standardVatRate = 0.15;
...
module.exports = new IntlTaxEngine_NZ();
