/**
 * International Tax Jurisdiction Engine: Canada_Alberta (CA_AB)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_CA_AB {
  constructor() {
    this.jurisdictionCode = 'CA_AB';
    this.countryName = 'Canada_Alberta';
    this.statutoryName = 'Goods and Services Tax (GST)';
    this.standardVatRate = 0.05;
    this.reducedVatRate = 0.05;
...
module.exports = new IntlTaxEngine_CA_AB();
