/**
 * International Tax Jurisdiction Engine: Singapore (SG)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_SG {
  constructor() {
    this.jurisdictionCode = 'SG';
    this.countryName = 'Singapore';
    this.statutoryName = 'Singapore GST';
    this.standardVatRate = 0.09;
...
module.exports = new IntlTaxEngine_SG();
