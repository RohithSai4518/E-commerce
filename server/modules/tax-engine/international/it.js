/**
 * International Tax Jurisdiction Engine: Italy (IT)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_IT {
  constructor() {
    this.jurisdictionCode = 'IT';
    this.countryName = 'Italy';
    this.statutoryName = 'Imposta sul Valore Aggiunto';
    this.standardVatRate = 0.22;
...
module.exports = new IntlTaxEngine_IT();
