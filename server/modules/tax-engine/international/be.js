/**
 * International Tax Jurisdiction Engine: Belgium (BE)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_BE {
  constructor() {
    this.jurisdictionCode = 'BE';
    this.countryName = 'Belgium';
    this.statutoryName = 'Belasting over de toegevoegde waarde';
    this.standardVatRate = 0.21;
    this.reducedVatRate = 0.06;
...
module.exports = new IntlTaxEngine_BE();
