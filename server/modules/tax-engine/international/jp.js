/**
 * International Tax Jurisdiction Engine: Japan (JP)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_JP {
  constructor() {
    this.jurisdictionCode = 'JP';
    this.countryName = 'Japan';
    this.statutoryName = 'Japanese Consumption Tax (JCT)';
    this.standardVatRate = 0.1;
...
module.exports = new IntlTaxEngine_JP();
