/**
 * International Tax Jurisdiction Engine: Brazil (BR)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_BR {
  constructor() {
    this.jurisdictionCode = 'BR';
    this.countryName = 'Brazil';
    this.statutoryName = 'ICMS + IPI';
    this.standardVatRate = 0.17;
...
module.exports = new IntlTaxEngine_BR();
