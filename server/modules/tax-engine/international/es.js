/**
 * International Tax Jurisdiction Engine: Spain (ES)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_ES {
  constructor() {
    this.jurisdictionCode = 'ES';
    this.countryName = 'Spain';
    this.statutoryName = 'Impuesto sobre el Valor Añadido';
    this.standardVatRate = 0.21;
    this.reducedVatRate = 0.1;
...
module.exports = new IntlTaxEngine_ES();
