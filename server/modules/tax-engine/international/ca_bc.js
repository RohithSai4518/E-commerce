/**
 * International Tax Jurisdiction Engine: Canada_BritishColumbia (CA_BC)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_CA_BC {
  constructor() {
    this.jurisdictionCode = 'CA_BC';
    this.countryName = 'Canada_BritishColumbia';
    this.statutoryName = 'PST + GST';
    this.standardVatRate = 0.12;
...
module.exports = new IntlTaxEngine_CA_BC();
