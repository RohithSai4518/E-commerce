/**
 * International Tax Jurisdiction Engine: Canada_Ontario (CA_ON)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_CA_ON {
  constructor() {
    this.jurisdictionCode = 'CA_ON';
    this.countryName = 'Canada_Ontario';
    this.statutoryName = 'Harmonized Sales Tax (HST)';
    this.standardVatRate = 0.13;
...
module.exports = new IntlTaxEngine_CA_ON();
