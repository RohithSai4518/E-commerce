/**
 * International Tax Jurisdiction Engine: Greece (GR)
 * Official statutory VAT/GST rate definitions, reduced rate schedules, intra-community rules, and VAT ID validation.
 */

class IntlTaxEngine_GR {
  constructor() {
    this.jurisdictionCode = 'GR';
    this.countryName = 'Greece';
    this.statutoryName = 'Foros Prostithemenis Axias';
    this.standardVatRate = 0.24;
    this.reducedVatRate = 0.13;
...
module.exports = new IntlTaxEngine_GR();
