/**
 * Tax Calculation Rules for North Carolina (NC)
...
class TaxRules_NC {
  constructor() {
    ...
    this.baseRate = 0.0475;
    this.averageLocalRate = 0.0225;
    this.combinedRate = 0.07000;
    this.isShippingTaxable = true;
...
module.exports = new TaxRules_NC();
