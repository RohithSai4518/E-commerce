/**
 * Carrier Integration Adapter: Fedex Express
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_FEDEX_EXPRESS {
  constructor() {
    this.carrierId = 'fedex-express';
    this.carrierName = 'Fedex Express';
...
module.exports = new CarrierAdapter_FEDEX_EXPRESS();
