/**
 * Carrier Integration Adapter: Usps First Class
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_USPS_FIRST_CLASS {
  constructor() {
    this.carrierId = 'usps-first-class';
    this.carrierName = 'Usps First Class';
...
module.exports = new CarrierAdapter_USPS_FIRST_CLASS();
