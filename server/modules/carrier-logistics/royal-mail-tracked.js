/**
 * Carrier Integration Adapter: Royal Mail Tracked
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_ROYAL_MAIL_TRACKED {
  constructor() {
    this.carrierId = 'royal-mail-tracked';
    this.carrierName = 'Royal Mail Tracked';
...
module.exports = new CarrierAdapter_ROYAL_MAIL_TRACKED();
