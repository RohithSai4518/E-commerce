/**
 * Carrier Integration Adapter: Fedex Priority
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_FEDEX_PRIORITY {
  constructor() {
    this.carrierId = 'fedex-priority';
    this.carrierName = 'Fedex Priority';
...
module.exports = new CarrierAdapter_FEDEX_PRIORITY();
