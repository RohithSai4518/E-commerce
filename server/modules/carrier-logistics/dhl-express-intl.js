/**
 * Carrier Integration Adapter: Dhl Express Intl
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_DHL_EXPRESS_INTL {
  constructor() {
    this.carrierId = 'dhl-express-intl';
    this.carrierName = 'Dhl Express Intl';
...
module.exports = new CarrierAdapter_DHL_EXPRESS_INTL();
