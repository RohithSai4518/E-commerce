/**
 * Carrier Integration Adapter: Yamato Transport Japan
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_YAMATO_TRANSPORT_JAPAN {
  constructor() {
    this.carrierId = 'yamato-transport-japan';
    this.carrierName = 'Yamato Transport Japan';
...
module.exports = new CarrierAdapter_YAMATO_TRANSPORT_JAPAN();
