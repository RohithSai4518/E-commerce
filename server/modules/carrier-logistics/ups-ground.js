/**
 * Carrier Integration Adapter: Ups Ground
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_UPS_GROUND {
  constructor() {
    this.carrierId = 'ups-ground';
    this.carrierName = 'Ups Ground';
...
module.exports = new CarrierAdapter_UPS_GROUND();
