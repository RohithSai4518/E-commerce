/**
 * Carrier Integration Adapter: Fedex Ground
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_FEDEX_GROUND {
  constructor() {
    this.carrierId = 'fedex-ground';
    this.carrierName = 'Fedex Ground';
...
module.exports = new CarrierAdapter_FEDEX_GROUND();
