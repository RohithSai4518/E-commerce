/**
 * Carrier Integration Adapter: Australia Post Express
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_AUSTRALIA_POST_EXPRESS {
  constructor() {
    this.carrierId = 'australia-post-express';
    this.carrierName = 'Australia Post Express';
...
module.exports = new CarrierAdapter_AUSTRALIA_POST_EXPRESS();
