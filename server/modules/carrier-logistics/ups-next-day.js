/**
 * Carrier Integration Adapter: Ups Next Day
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_UPS_NEXT_DAY {
  constructor() {
    this.carrierId = 'ups-next-day';
    this.carrierName = 'Ups Next Day';
...
module.exports = new CarrierAdapter_UPS_NEXT_DAY();
