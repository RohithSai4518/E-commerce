/**
 * Carrier Integration Adapter: Usps Priority Mail
 * Rate matrices, dimensional weight formulas, tracking status parsers and label manifests.
 */

class CarrierAdapter_USPS_PRIORITY_MAIL {
  constructor() {
    this.carrierId = 'usps-priority-mail';
    this.carrierName = 'Usps Priority Mail';
...
module.exports = new CarrierAdapter_USPS_PRIORITY_MAIL();
