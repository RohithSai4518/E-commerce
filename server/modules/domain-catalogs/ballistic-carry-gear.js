/**
 * Domain Catalog & Specification Matrix: BallisticCarryGear
 * Production specifications, variant trees, pricing formulas, compliance certs, and test vectors.
 */

class BallisticCarryGearDomainModel {
  constructor() {
    this.sectorKey = 'ballistic-carry-gear';
  ...
  buildCatalogMatrix() {
    ...
    for (let i = 1; i <= 20; i++) {
      ...
      items.push({
        itemCode: 'BAL-' + String(i).padStart(3, '0'),
        title: 'BallisticCarryGear ' + tiers[tierIndex] + ' Model ' + i,
        basePrice: price,
...
module.exports = new BallisticCarryGearDomainModel();
